...
app = FastAPI(
    ...
    version="1.0.0",
    openapi_url="/items/openapi.json",  # Add the prefix here
...
@app.get("/items/complaint/get/{complain_id}", response_model=RailSathiComplainResponse)
...
@app.get("/items/complaint/get/date/{date_str}", response_model=List[RailSathiComplainResponse])
...
@app.post("/items/complaint/add", response_model=RailSathiComplainResponse)
@app.post("/items/complaint/add/", response_model=RailSathiComplainResponse)
...
@app.patch("/items/complaint/update/{complain_id}", response_model=RailSathiComplainResponse)
...
@app.put("/items/complaint/update/{complain_id}", response_model=RailSathiComplainResponse)
...
@app.delete("/items/complaint/delete/{complain_id}")
...
@app.delete("/items/media/delete/{complain_id}")
...
@app.get("/items/train_details/{train_no}")
